...
This pseudocode is _accurate_, but it isn't very _efficient_.  You should discuss the other strategies with your peers to look for more efficient implementations. 
